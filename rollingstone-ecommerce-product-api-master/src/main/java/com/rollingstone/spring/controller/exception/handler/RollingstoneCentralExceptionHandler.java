...
//	public final ResponseEntity<RestAPIExceptionInfo> handleAllExceptions(HTTP400Exception ex, WebRequest request) {
//		RestAPIExceptionInfo exceptionResponse = new RestAPIExceptionInfo(new Date(), ex.getMessage(),
//			request.getDescription(false));
...
//	public final ResponseEntity<RestAPIExceptionInfo> handleAllExceptions(HTTP404Exception ex, WebRequest request) {
//		RestAPIExceptionInfo exceptionResponse = new RestAPIExceptionInfo(new Date(), ex.getMessage(),
//			request.getDescription(false));
